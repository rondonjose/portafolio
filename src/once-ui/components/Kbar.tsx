...
export const KbarContent: React.FC<KbarContentProps> = ({ isOpen, onCloseAction, items }) => {
  ...
  }, [nonCustomOptions, items, router, onCloseAction, highlightedIndex]);
          ...
          {groupedItems.map((option, index) => {
            ...
            return (
              <Option
                ...
                {...(option.href 
                  ? { href: option.href, onClick: undefined, onLinkClick: onCloseAction } 
